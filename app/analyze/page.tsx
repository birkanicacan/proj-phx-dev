          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  className="w-full bg-white border border-gray-300 rounded-md py-2 pl-3 pr-10 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                  defaultValue=""
                >
                  <option value="" disabled>What would you like to plot?</option>
                  <option value="feedback_volume">Feedback Volume</option>
            ...
            <div>
              ...
              <div className="space-y-2">
                <button className="w-full text-left px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-md border border-dashed border-gray-300 rounded-md">
                  + Add Filter
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-2 text-sm">
                ...
                <button className="px-2 py-1 rounded text-gray-600 hover:bg-gray-100">
                  Custom
                </button>
              </div>
            </div>
